...
class CategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final subcategoryImages = {
      ...
      womenDress: featuredListImages1[6],
      ...
      officeWear: featuredListImages2[6],
      // featuredTitles3
      babyClothes: featuredListImages3[1],
      childrenShirts: featuredListImages3[2],
      childrenSets: featuredListImages3[3],
      childrenPants: featuredListImages3[4],
      // featuredTitles4
      middleAgedDress: featuredListImages4[1],
      middleAgedSets: featuredListImages4[2],
      // featuredTitles5
      necklace: featuredListImages5[1],
      gold: featuredListImages5[2],
      earrings: featuredListImages5[3],
      // featuredTitles6
      menWatches: featuredListImages6[1],
      menHats: featuredListImages6[2],
      menShoes: featuredListImages6[3],
      // featuredTitles7
      womenWatches: featuredListImages7[1],
      womenShoes: featuredListImages7[2],
      handBag: featuredListImages7[3],
    };
